...
class RAGEngine:
    ...
    def load(self, force=False):
        ...
        # Initialize components in-process for speed
...
2. Answer the user's question based on the provided context, but make a dry joke or sarcastic remark.
3. Keep it brief.
...
{context}"""),
    ...
    def query(self, query_text):
        ...
        if not self.is_loaded:
            return "Error: Chroma database or BM25 index not found. Please upload and ingest a document first."

        # Measure Total Chain Time
        ...
        # 1 token ≈ 4 characters rule-of-thumb
        ...
        # Print report to server console
        print(f"\n{report}\n")

        # Return only the raw LLM generated answer for a clean chatbot simulation
